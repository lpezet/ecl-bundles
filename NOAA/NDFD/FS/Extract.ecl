...
IMPORT NOAA.NDFD.FS.Datasets;
IMPORT LPezet.Linux.Curl;
IMPORT LPezet.Linux.BinUtils;
IMPORT NOAA.NDFD.FS.WGrib2;
/*
	...
	TODO:
		...
		Overhaul: download "NDFD Products Spreadsheet" from this page: http://graphical.weather.gov/docs/datamanagement.php.
			Actual download link at the time is: http://graphical.weather.gov/docs/NDFDelem_fullres.xls
			Use ssconvert (Gnumeric) or some xls2csv software to extract sheets to csv from that document.
			Then load info and use it to figure out files for each element provided in NDFD.
